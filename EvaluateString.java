...
{ 
	...
	{ 
		...
		{ 
			...
			{ 
				...
				while (i < tokens.length && tokens[i] >= '0' && tokens[i] <= '9'|| tokens[i]=='.' && i < tokens.length) 
	...
	{ 
		System.out.println(EvaluateString.evaluate("10 + 2 * 6.2")); 
		System.out.println(EvaluateString.evaluate("100 * 2 + 12")); 
		System.out.println(EvaluateString.evaluate("100 * ( 2 + 12 )")); 
		System.out.println(EvaluateString.evaluate("100 * ( 2 + 12 ) / 14")); 
		System.out.println(EvaluateString.evaluate("( 1 + 2 ) * ( 9 / 3 )")); 
